...
import MongoDbUserRepository from '../../../../../src/api/users/insfrastructure/mongo-db/mongoDbUserRepository';
...
jest.mock(
  '../../../../../src/api/users/insfrastructure/mongo-db/mongoDbUserRepository'
);
